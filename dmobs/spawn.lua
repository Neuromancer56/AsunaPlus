...
--	neighbor = {"darkage:slate"}
	...
	mobs:spawn({name = "dmobs:golem", nodes = {"group:stone"}, neighbor = {}, min_light = 0,
		max_light = 7, interval = 300, chance = 4000, active_object_count = 4, min_height = -32000, max_height = 100})  --16000,2
	mobs:spawn({name = "dmobs:pig_evil", nodes = {"group:leave", "ethereal:bamboo_leaves"}, neighbor = {},
		min_light = 10, max_light = 15, interval = 300, chance = 16000, active_object_count = 4, min_height = 0, max_height = 2000})  --54000,2
...
-- Orcs and ogres spawn more often when dragons are disabled
	if not dmobs.dragons then
		mobs:spawn({name = "dmobs:orc",
			...
			neighbor = {}, min_light = 0, max_light = 10, interval = 300, chance = 2000,
			active_object_count = 4, min_height = 0, max_height = 2000}) --6000, 2
		mobs:spawn({name = "dmobs:ogre",
			nodes = {"default:snow_block", "default:permafrost_with_moss", "default:permafrost_with_stone", "ethereal:cold_dirt"},
			neighbor = {}, min_light = 0, max_light = 10, interval = 300, chance = 4000,
			active_object_count = 4, min_height = 0, max_height = 2000})  --16000, 2
	else
		mobs:spawn({name = "dmobs:orc",
			nodes = {"default:snow_block", "default:permafrost_with_moss", "default:permafrost_with_stone", "ethereal:cold_dirt"},
			neighbor = {}, min_light = 0, max_light = 10, interval = 300, chance = 2000,
			active_object_count = 4, min_height = 0, max_height = 2000})  --8000, 2
		mobs:spawn({name = "dmobs:ogre",
			nodes = {"default:snow_block", "default:permafrost_with_moss", "default:permafrost_with_stone", "ethereal:cold_dirt"},
			neighbor = {}, min_light = 0, max_light = 10, interval = 300, chance = 8000,
			active_object_count = 4, min_height = 0, max_height = 2000}) --32000, 2
	end
end
...
if dmobs.dragons then  --just divided chance by 4.
	...
	mobs:spawn({name = "dmobs:dragon3", nodes = {"ethereal:jungle_dirt", "default:jungleleaves"}, neighbor = {},
		min_light = 0, max_light = 10, interval = 300, chance = 6000, active_object_count = 2, min_height = 0, max_height = 30000})
	...
	mobs:spawn({name = "dmobs:waterdragon", nodes = {"default:water_source"}, neighbor = {"air"},
		min_light = 0, max_light = 15, interval = 300, chance = 8000, active_object_count = 2, min_height = -10, max_height = 100})
	...
	mobs:spawn({name = "dmobs:dragon_great",
		...
		min_light = 0, max_light = 15, interval = 300, chance = 8000, active_object_count = 2, min_height = -30000, max_height = 30000})
end
