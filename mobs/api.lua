...
function mob_class:do_env_damage()
	...
	if self.light_damage ~= 0 then
		...
		local light = minetest.get_natural_light(pos) or 0
	...
	-- is mob natural light sensitive, or scared of the dark :P
	--if self.natural_light_damage ~= 0 then

		--local natural_light = minetest.get_natural_light(pos) or 0

		--if natural_light >= self.natural_light_damage_min
		--and natural_light <= self.natural_light_damage_max then

			--self.health = self.health - self.natural_light_damage
